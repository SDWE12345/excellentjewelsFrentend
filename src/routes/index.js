...
import ChooseJewellery from 'Components/CustomizeRing/ChooseJewellery';
import ChooseYourSetting from 'Components/CustomizeRing/ChooseYourSetting';
  ...
  return (
    <Suspense fallback={<Loader/>}>
      ...
      <Routes>
        ...
        <Route path="/setting-diamond-wise" element={<ChooseDiamond />} />
        <Route path="/setting-jewellery-wise" element={<ChooseJewellery />} />
